function [gapCloseParam,costMatrices,  kalmanFunctions, probDim,verbose]=kinTrackingParamV2()
...
parameters.minSearchRadius = 8; %minimum allowed search radius. The search radius is calculated on the spot in the code given a feature's motion parameters. If it happens to be smaller than this minimum, it will be increased to the minimum.
...
parameters.kalmanInitParam.searchRadiusFirstIteration = 9; %Kalman filter initialization parameters.
