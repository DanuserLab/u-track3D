...
parameters.maxSearchRadius = 3*sqrt(p.decimationFactor); %maximum allowed search radius. Again, if a feature's calculated search radius is larger than this maximum, it will be reduced to this maximum.
